...
int main()
{
    ...
    triangle_matrix_set(&test, 2, 1, 2, ROW_MAPPING);
    triangle_matrix_set(&test, 3, 1, 3, ROW_MAPPING);
    triangle_matrix_set(&test, 3, 2, 3, ROW_MAPPING);
    triangle_matrix_set(&test, 4, 1, 4, ROW_MAPPING);
    triangle_matrix_set(&test, 5, 1, 5, ROW_MAPPING);
    triangle_matrix_set(&test, 5, 5, 5, ROW_MAPPING);
    int value = triangle_matrix_get(&test, 2, 2, ROW_MAPPING);
    printf("The value at 2,2 in the upper triangle matrix is %d\n", value);
    
    triangle_matrix_display(&test, ROW_MAPPING);
    triangle_matrix_set(&test, 4, 5, 6, ROW_MAPPING);
    ...
    triangle_matrix_set(&test2, 2, 1, 2, COLUMN_MAPPING);
    triangle_matrix_set(&test2, 3, 1, 3, COLUMN_MAPPING);
    triangle_matrix_set(&test2, 3, 2, 3, COLUMN_MAPPING);
    triangle_matrix_set(&test2, 4, 1, 4, COLUMN_MAPPING);
    triangle_matrix_set(&test2, 5, 1, 5, COLUMN_MAPPING);
    ...
    triangle_matrix_set(&test2, 4, 5, 6, COLUMN_MAPPING);
    return 0;
}
...
void triangle_matrix_set(Matrix *mtx, int x_axis, int y_axis, int value, int mapping)
{
    if (y_axis > x_axis)
    {
        printf("Value cannot be added to upper triangle matrix as y-axis %d is greater than x-axis %d\n", y_axis, x_axis);
    }
